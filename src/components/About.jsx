  ...
  return (
    <>
      <section class="about" id="about">
        ...
        <section style={{ marginTop: "0px" }} className="about2">
          <div className="welcome">
            <div className="para">
              <p>
                ...
                websites, software, and digital solutions that exceed
                expectations while staying within your budget and timeline.{" "}
                <br /> <br />
                Whether you're a startup, small business, or large enterprise,
                we're here to help you thrive in the digital landscape. We
                believe in transparency and collaboration, which is why we offer
                free consultations to discuss your project requirements. <br />{" "}
                <br /> Feel free to reach out to us, because at Software Synergy
        ...
        <div class="row">
          <div class="image">
            <img draggable="false" class="tilt" src={two} alt="" />
          </div>
